...
for i,site_id in enumerate(site_ids):
	print(i)
	per_site_res = combined_df[(combined_df['site_id'] == site_id)&(combined_df['wtemp_predicted-linear_model'])]
...
per_site_df.to_csv("../../results/err_per_site_wBachmann_summerOnly.csv")
