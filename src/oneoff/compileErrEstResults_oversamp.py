...
for k in folds_arr: #CHANGE DIS----------------
	...
	ea_df = pd.read_feather("../../results/err_est_outputs_072621_EALSTM_fold"+str(k)+"_oversamp_norm4.feather")
	# ea_df = pd.read_feather("../../results/err_est_outputs_072621_EALSTM_fold"+str(k)+"_oversamp_norm5.feather")
...
print("n predict > 33")
print(combined_df[combined_df['wtemp_predicted-ealstm']>33].shape[0])
print("n predict > 34")
print(combined_df[combined_df['wtemp_predicted-ealstm']>34].shape[0])
print("n predict > 35")
print(combined_df[combined_df['wtemp_predicted-ealstm']>35].shape[0])
print("n predict > 36")
print(combined_df[combined_df['wtemp_predicted-ealstm']>36].shape[0])

print("n predict > 33")
print(combined_df[combined_df['wtemp_actual']>33].shape[0])
print("n predict > 34")
print(combined_df[combined_df['wtemp_actual']>34].shape[0])
print("n predict > 35")
print(combined_df[combined_df['wtemp_actual']>35].shape[0])
print("n predict > 36")
print(combined_df[combined_df['wtemp_actual']>36].shape[0])
pdb.set_trace()
