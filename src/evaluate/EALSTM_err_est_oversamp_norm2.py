...
#oversampling routine
trn_data = np.load("../evaluate/ealstm_trn_data_5fold_k"+str(int(k))+".npy")
...
final_output_df.to_feather("../../results/err_est_outputs_EALSTM_fold"+str(k)+"_oversamp_norm2.feather")
